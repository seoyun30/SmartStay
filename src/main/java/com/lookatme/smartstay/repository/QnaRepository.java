...
public interface QnaRepository extends JpaRepository<Qna, Long> {
    ...
    @Query("select q from Qna q where q.title like concat('%', :str, '%') or q.content like concat('%', :str, '%') and q.hotel.hotel_num = :hotel_num")
    public Page<Qna> titleOrConAndHotel_numContaining(String str, Long hotel_num, Pageable pageable);
